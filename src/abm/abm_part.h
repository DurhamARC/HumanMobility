 ...
 *
 ******************************************************************************/
#ifndef SWIFT_ABM_PART_H
#define SWIFT_ABM_PART_H

/* Import the right ABM part definition */
#if defined(NONE_ABM)
#include "./None/abm_part.h"
#elif defined(HUMANMOBILITY_ABM)
#include "./HumanMobility/abm_part.h"
#define hydro_need_extra_init_loop 0
#else
#error "Invalid choice of ABM variant"
#endif

#endif /* SWIFT_ABM_PART_H */
